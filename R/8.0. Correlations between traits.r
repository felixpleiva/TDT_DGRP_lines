...
# -------------------------------------------------------------------------------------
{
pdf("8.2.1. Figure S2 Pairwise correlation between traits (individual values, females and males pooled).pdf",width = 7,height = 7)
#png("8.2.1. Figure S2 Pairwise correlation between traits (individual values, females and males pooled).png",width = 7,height = 7,units = "in",res = 600)
...
# -------------------------------------------------------------------------------------
{
pdf("8.2.2. Figure S3 Pairwise correlation between between traits (mean values for females and males pooled).pdf",width = 7,height = 7)
#png("8.2.2. Figure S3 Pairwise correlation between between traits (mean values for females and males pooled).png",width = 7,height = 7,units = "in",res = 600)
par(mfrow=c(1,1),tcl=-0.4, family="serif",
      omi=c(0,0,0,0))
my_cols <- c('#4DAC2660', '#A6761D60')
panel.cor <- function(x, y){
...
{
pdf("8.2.3. Figure S4 Pairwise correlation between between traits (mean values for females).pdf",width = 7,height = 7)
#png("8.2.3. Figure S4 Pairwise correlation between between traits (mean values for females).png",width = 7,height = 7,units = "in",res = 600)
par(mfrow=c(1,1),tcl=-0.4, family="serif",
    omi=c(0,0,0,0))
...
#Figure S6
Figure_S6<-plot_grid(f2.plot,m1.plot,a1.plot,
...
#Store Plots
ggsave('8.2.5. Figure S6 Allometric relationships between traits.pdf',Figure_S6,width=12,height=15)
ggsave('8.2.5. Figure S6 Allometric relationships between traits.png',Figure_S6,width=14,height=17,dpi = 600)
#-------------------------------------------------------------------------------
#saving session information with all packages versions for reproducibility
#purposes
sink("C:/Users/Invunche/Dropbox/GitHub/TDT_DGRP_lines/Outputs/8.1.1. Correlations between traits_R_session.txt")
sessionInfo()
sink()
################################################################################
############################ END OF SCRIPT #####################################
