...
datos<-read.xlsx("results on TDT available.xlsx", sheetName = "results on TDT available")
...
write.csv(all.lines.21, "4.1.1. Survival time of Drosophila melanogaster and its associated size traits at 21 kPa.csv",row.names=FALSE)
write.csv(all.lines.10, "4.1.2. Survival time of Drosophila melanogaster and its associated size traits at two oxygen levels.csv",row.names=FALSE)
#-------------------------------------------------------------------------------
#saving session information with all packages versions for reproducibility
#purposes
sink("C:/Users/Invunche/Dropbox/GitHub/TDT_DGRP_lines/Outputs/4.1.3. Exploratory analysis TDT curves_R_session.txt")
sessionInfo()
sink()
################################################################################
############################ END OF SCRIPT #####################################
