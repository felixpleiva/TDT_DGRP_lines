...
#   
#                                                   K    AICc Delta_AICc AICcWt Cum.Wt    LL
# TT + TT * O2 * Sex + TT * O2 * CA                13 -107.07       0.00   0.84   0.84 68.87
# TT + TT * O2 * Sex                                9 -102.26       4.81   0.08   0.91 61.23
# TT + TT * O2 * CA                                 9 -101.85       5.22   0.06   0.97 61.02
# TT + TT * O2                                      5  -98.32       8.75   0.01   0.98 54.51
# TT + TT * O2 * Sex + TT * O2 * CA + TT * O2 * FM 17  -98.28       8.79   0.01   0.99 70.27
# TT + TT * O2 * Sex + TT * O2 * FM                13  -96.25      10.82   0.00   1.00 63.46
# TT + TT * O2 * CA  + TT * O2 * FM                13  -93.70      13.36   0.00   1.00 62.19
# TT + TT * O2 * FM                                 9  -92.58      14.48   0.00   1.00 56.39
# TT                                                3  -83.93      23.13   0.00   1.00 45.10

#export table
write.csv(fit.table.3,"../Outputs/6.1.2. Table 3 Model comparison of survival time at two kPa.csv",row.names = FALSE)

#-------------------------------------------------------------------------------
# TABLE S7 SUPPLEMENTARY INFORMATION
#-------------------------------------------------------------------------------
summary(hyp_5)
